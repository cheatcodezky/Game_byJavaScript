...
var xStep = null;
var yStep = null;
var amountRadish1 = 10;
var cave = null;
var winBoard1 = null;
var EatRadishLayer1 = cc.Layer.extend({
    radishGroup:null,
    winBoard1:null,
    key:0,
    lose:null,
    ...
    removerabbit1:function(){
        ...
        if(amountRadish1==0 && Math.abs(rabbit1.x - cave.x )<xStep&&Math.abs(rabbit1.y-cave.y)<yStep && this.key==0){
...
var EatRadishScene1 = cc.Scene.extend({
    onEnter:function(){
        this._super();
        var layer = new EatRadishLayer1();
        this.addChild(layer);
    }
})